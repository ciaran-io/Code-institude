    ...
    var e = {
          ...
          var h = (function () {
            ...
            return (
              ...
              (e.prototype._parseColor = function (e, t, r) {
                if (
                  (void 0 === r && (r = this.allowTransparency), void 0 === e)
                )
                  return t;
                if (
              ...
              return (
                ...
                (t.prototype._onHover = function (e) {
                  if (this._activeLine !== e.y)
                    return (
                      this._clearCurrentLink(), void this._askForLink(e, !1)
                    );
                  (this._currentLink &&
                  ...
                  r !== this._currentZone &&
                    ...
                    r &&
                      ...
                      (this._tooltipTimeout = window.setTimeout(function () {
                        ...
                        ._optionsService.options.linkTooltipHoverDuration))));
                }),
              ...
              return (
                ...
                (t.prototype.open = function (e) {
                  ...
                  (this._renderService = this.register(
                    ...
                    this.register(
                      this._selectionService.onLinuxMouseSelection(function (
                        e
                      ) {
                        (t.textarea.value = e),
                          t.textarea.focus(),
                  ...
                  this.register(
                    ...
                    this.register(
                      d.addDisposableDomListener(
                        ...
                        function (t) {
                          if (!n.wheel)
                            return e.viewport.onWheel(t) ? void 0 : e.cancel(t);
                        },
                        { passive: !1 }
                      )
                    ),
                ...
                (t.prototype._keyDown = function (e) {
                  ...
                  if (
                    (this.updateCursorStyle(e), 3 === t.type || 2 === t.type)
                  ) {
                    var r = this.rows - 1;
                    return (
                ...
                for (
                  ...
                  if (
                    ...
                    if (this._workCell.fg !== c || this._workCell.bg !== l) {
                      if (h - n > 1)
                        for (
                          var u = this._getJoinedRanges(i, a, o, t, n), f = 0;
                          f < u.length;
                          f++
                        )
                          r.push(u[f]);
              ...
              (e.prototype._stringRangesToCellRanges = function (e, t, r) {
                ...
                if (a) {
                  for (var c = r; c < this._bufferService.cols; c++) {
                    var l = t.getWidth(c),
                      h =
                        t.getString(c).length || s.WHITESPACE_CELL_CHAR.length;
                    if (0 !== l) {
                      if (
                        (!n && a[0] <= o && ((a[0] = c), (n = !0)), a[1] <= o)
                      ) {
              ...
              return (
                ...
                (t.prototype._drawBackground = function (e, t) {
                  ...
                  i.save(),
                    this._forEachCell(e, t, null, function (e, t, l) {
                      ...
                      e.isInverse()
                        ? (h = e.isFgDefault()
                            ...
                            : e.isFgRGB()
                            ? "rgb(" +
                              a.AttributeData.toColorRGB(e.getFgColor()).join(
                                ","
                              ) +
                              ")"
                        ...
                        ? (h =
                            "rgb(" +
                            a.AttributeData.toColorRGB(e.getBgColor()).join(
                              ","
                            ) +
                            ")")
                        : e.isBgPalette() &&
                    ...
                    null !== c &&
                      ((i.fillStyle = c), this._fillCells(o, s, n - o, 1)),
                    i.restore();
                }),
        ...
        1906: function (e, t, r) {
          ...
          var d = (function (e) {
            function t(t, r) {
              ...
              return (
                (i._cacheMap = new c.LRUMap(o)), i._cacheMap.prealloc(o), i
              );
            }
            return (
              n(t, e),
            ...
            y = (function (e) {
              ...
              return (
                ...
                (t.prototype._getMouseEventScrollAmount = function (e) {
                  var t = _.getCoordsRelativeToElement(
                      e,
                      this._screenElement
                    )[1],
                ...
                (t.prototype.shouldColumnSelect = function (e) {
                  return (
                    ...
                    !(
                      a.isMac &&
                      this._optionsService.options.macOptionClickForcesSelection
                    )
                  );
                }),
                (t.prototype._onMouseMove = function (e) {
                      ...
                      if (t || "" !== s.slice(a, c).trim()) {
                        if (r && 0 === b && 32 !== o.getCodePoint(0)) {
                          ...
                          if (
                            m &&
                            o.isWrapped &&
                            32 !== m.getCodePoint(this._bufferService.cols - 1)
                          ) {
            ...
            S = (function (e) {
              function t(t) {
                ...
                return (
                  ...
                  r.register(
                    f.forwardEvent(r._inputHandler.onLineFeed, r._onLineFeed)
                  ),
                  ...
                  if (0 === i.scrollTop) {
                    ...
                    o === i.lines.length - 1
                      ...
                      s
                        ...
                        : (i.ybase++,
                          this._bufferService.isUserScrolling || i.ydisp++);
                  } else {
                    var a = o - n + 1;
        ...
        5435: function (e, t, r) {
          ...
          !(function (e) {
            ...
            (o =
              t.WindowsOptionsReportType || (t.WindowsOptionsReportType = {}))
          );
          var C = (function () {
              function e(e, t, r, i) {
                (this._bufferService = e),
              ...
              function t(t, r, i, n, o, l, h, d, v) {
                ...
                (y._bufferService = t),
                  ...
                  y._parser.setExecuteHandlerFallback(function (e) {
                    y._logService.debug("Unknown EXECUTE code: ", { code: e });
                  }),
                  ...
                  y._parser.registerCsiHandler({ final: "@" }, function (e) {
                  ...
                  y._parser.registerCsiHandler({ final: "A" }, function (e) {
                    return y.cursorUp(e);
                  }),
                  y._parser.registerCsiHandler(
                  ...
                  y._parser.registerCsiHandler({ final: "B" }, function (e) {
                    return y.cursorDown(e);
                  }),
                  y._parser.registerCsiHandler({ final: "C" }, function (e) {
                    return y.cursorForward(e);
                  }),
                  y._parser.registerCsiHandler({ final: "D" }, function (e) {
                    return y.cursorBackward(e);
                  }),
                  y._parser.registerCsiHandler({ final: "E" }, function (e) {
                    return y.cursorNextLine(e);
                  }),
                  y._parser.registerCsiHandler({ final: "F" }, function (e) {
                    return y.cursorPrecedingLine(e);
                  }),
                  y._parser.registerCsiHandler({ final: "G" }, function (e) {
                    return y.cursorCharAbsolute(e);
                  }),
                  y._parser.registerCsiHandler({ final: "H" }, function (e) {
                    return y.cursorPosition(e);
                  }),
                  y._parser.registerCsiHandler({ final: "I" }, function (e) {
                    return y.cursorForwardTab(e);
                  }),
                  y._parser.registerCsiHandler({ final: "J" }, function (e) {
                  ...
                  y._parser.registerCsiHandler({ final: "K" }, function (e) {
                  ...
                  y._parser.registerCsiHandler({ final: "L" }, function (e) {
                    return y.insertLines(e);
                  }),
                  y._parser.registerCsiHandler({ final: "M" }, function (e) {
                    return y.deleteLines(e);
                  }),
                  y._parser.registerCsiHandler({ final: "P" }, function (e) {
                    return y.deleteChars(e);
                  }),
                  y._parser.registerCsiHandler({ final: "S" }, function (e) {
                    return y.scrollUp(e);
                  }),
                  y._parser.registerCsiHandler({ final: "T" }, function (e) {
                    return y.scrollDown(e);
                  }),
                  y._parser.registerCsiHandler({ final: "X" }, function (e) {
                    return y.eraseChars(e);
                  }),
                  y._parser.registerCsiHandler({ final: "Z" }, function (e) {
                  ...
                  y._parser.registerCsiHandler({ final: "n" }, function (e) {
                  ...
                  y._parser.registerCsiHandler({ final: "r" }, function (e) {
                  ...
                  y._parser.registerCsiHandler({ final: "u" }, function (e) {
                  ...
                  y._parser.registerEscHandler({ final: "7" }, function () {
                    return y.saveCursor();
                  }),
                  y._parser.registerEscHandler({ final: "8" }, function () {
                    return y.restoreCursor();
                  }),
                  y._parser.registerEscHandler({ final: "D" }, function () {
                    return y.index();
                  }),
                  y._parser.registerEscHandler({ final: "E" }, function () {
                    return y.nextLine();
                  }),
                  y._parser.registerEscHandler({ final: "H" }, function () {
                    return y.tabSet();
                  }),
                  y._parser.registerEscHandler({ final: "M" }, function () {
                    return y.reverseIndex();
                  }),
                  y._parser.registerEscHandler({ final: "=" }, function () {
                    return y.keypadApplicationMode();
                  }),
                  y._parser.registerEscHandler({ final: ">" }, function () {
                    return y.keypadNumericMode();
                  }),
                  y._parser.registerEscHandler({ final: "c" }, function () {
                    return y.fullReset();
                  }),
                  y._parser.registerEscHandler({ final: "n" }, function () {
                    return y.setgLevel(2);
                  }),
                  y._parser.registerEscHandler({ final: "o" }, function () {
              ...
              return (
                ...
                (t.prototype.parse = function (e) {
                  ...
                  if (
                    ...
                    (s =
                      ...
                      this._parser.parse(this._parseBuffer, s);
                  ((t = this._bufferService.buffer).x === r && t.y === i) ||
                ...
                (t.prototype.print = function (e, t, r) {
                  ...
                  for (var p = t; p < r; ++p) {
                    ...
                    if (
                      (a && this._onA11yChar.fire(u.stringFromCodePoint(i)),
                      n || !o.x)
                    ) {
                      if (o.x + n - 1 >= c)
                        if (l) {
                  ...
                  r - t > 0 &&
                    ...
                    o.x < c &&
                      ...
                      0 === _.getWidth(o.x) &&
                      !_.hasContent(o.x) &&
                      _.setCellFromCodePoint(o.x, 0, 1, f.fg, f.bg, f.extended),
                    this._dirtyRowService.markDirty(o.y);
                }),
                (t.prototype.addCsiHandler = function (e, t) {
                  var r = this;
                ...
                (t.prototype.backspace = function () {
                  ...
                  if ((this._restrictCursor(this._bufferService.cols), t.x > 0))
                    t.x--;
                  else if (
                    0 === t.x &&
                    t.y > t.scrollTop &&
                    t.y <= t.scrollBottom &&
                    (null === (e = t.lines.get(t.ybase + t.y)) || void 0 === e
                      ? void 0
                      : e.isWrapped)
                  ) {
                ...
                (t.prototype.cursorNextLine = function (e) {
                  return (
                    this.cursorDown(e), (this._bufferService.buffer.x = 0), !0
                  );
                }),
                (t.prototype.cursorPrecedingLine = function (e) {
                  return (
                    this.cursorUp(e), (this._bufferService.buffer.x = 0), !0
                  );
                }),
                ...
                (t.prototype.insertLines = function (e) {
                  ...
                  return (
                    this._dirtyRowService.markRangeDirty(r.y, r.scrollBottom),
                    (r.x = 0),
                    !0
                  );
                }),
                ...
                (t.prototype._is = function (e) {
                  return (
                    0 ===
                    (this._optionsService.options.termName + "").indexOf(e)
                  );
                }),
                ...
                (t.prototype.windowOptions = function (e) {
                  if (
                    !m(e.params[0], this._optionsService.options.windowOptions)
                  )
                    return !0;
                ...
                if (i.length > 0) {
                  ...
                  for (
                    ...
                    if (D && D.start > k + T) {
                      ...
                      v++,
                        L.push({ index: k + 1, amount: D.newLines.length }),
                        (T += D.newLines.length),
                        (D = i[++x]);
              ...
              return (
                ...
                (e.prototype._put = function (e, t, r) {
                  if (this._active.length)
                    ...
                    this._handlerFb(this._id, "PUT", n.utf32ToString(e, t, r));
                }),
              ...
              return (
                ...
                (e.prototype.setOption = function (e, r) {
                  ...
                  this.options[e] !== r &&
                    ...
                    this.options[e] !== r &&
                      ((this.options[e] = r), this._onOptionChange.fire(e)));
                }),
